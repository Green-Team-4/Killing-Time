                ...
                <CTableBody>
                  {
                    ...
                    <CTableRow>
                      ...
                      <CTableDataCell><Link to="/dramaMain/dramaDetails" state={{ id: dramaChart.results[0].id }}><img style={{width:151, height:201}} src={`https://www.themoviedb.org/t/p/w220_and_h330_face${dramaChart.results[0].poster_path}`} alt=""></img></Link></CTableDataCell>
                  ...
                  }
                  {
                    ...
                    <CTableRow>
                      ...
                      <CTableDataCell><Link to="/dramaMain/dramaDetails" state={{ id: dramaChart.results[1].id }}><img style={{width:151, height:201}} src={`https://www.themoviedb.org/t/p/w220_and_h330_face${dramaChart.results[1].poster_path}`} alt=""></img></Link></CTableDataCell>
                  ...
                  }
                  {
                    ...
                    <CTableRow>
                      ...
                      <CTableDataCell><Link to="/dramaMain/dramaDetails" state={{ id: dramaChart.results[2].id }}><img style={{width:151, height:201}} src={`https://www.themoviedb.org/t/p/w220_and_h330_face${dramaChart.results[2].poster_path}`} alt=""></img></Link></CTableDataCell>
                  ...
                  }
                  {
                    ...
                    <CTableRow>
                      ...
                      <CTableDataCell><Link to="/dramaMain/dramaDetails" state={{ id: dramaChart.results[3].id }}><img style={{width:151, height:201}} src={`https://www.themoviedb.org/t/p/w220_and_h330_face${dramaChart.results[3].poster_path}`} alt=""></img></Link></CTableDataCell>
                  ...
                  }
                  {
                    ...
                    <CTableRow>
                      <CTableHeaderCell>4</CTableHeaderCell>
                      <CTableDataCell><Link to="/dramaMain/dramaDetails" state={{ id: dramaChart.results[4].id }}><img style={{width:151, height:201}} src={`https://www.themoviedb.org/t/p/w220_and_h330_face${dramaChart.results[4].poster_path}`} alt=""></img></Link></CTableDataCell>
