...
//         const display = 5;
//         const url2 = `https://openapi.naver.com/v1/search/news.json?query=${query}&display=${display}&sort=sim&start=1&X-Naver-Client-Id=${ClientId}&X-Naver-Client-Secret=${ClientSecret}`;
